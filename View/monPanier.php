    ...
    <div>
        ...
        <input type='hidden' name='prixTotal' value='" . $prixTotal . "'>";
            ...
            if (isset($_SESSION['login'])) {
                ...
                //Bouton valider et payer panier
                echo '<br></form><button href="connexion">Valider</button></center>';
            }
        } else {
        ...
        if (isset($_SESSION["login"])) {
            ...
            foreach ($resultGCo as $resGCo) {
                ...
                foreach ($resultGCP as $resGCP) {
                    $texte .= "<li>" . $resGCP["pr_nom"] . " (X" . $resGCP["pr_quantite"] . ") prix unitaire: " . round($resGCP["pr_coutHT"] * 1.20, 2) . " €</li>";
                }
                ...
                $texte .= "<br><u>Prix HT:</u> " . $resGCo["co_prixTotal"] . "€ <br><span style='font-size:15px; font-style:italic'>&emsp;+ 20 % TVA <br>&emsp;+ 5€ frais de port</span><br> <u>Prix TTC:</u> <b>" . round($prixTotal, 2) . "€ </b></p>";
                echo $texte . "</div>";
            }
        }
