...
//Avoir les infos de la commande
    $sql = "SELECT co_id, co_prixTotal, pr_reference, pr_nom, pr_quantite, pr_coutHT FROM `commande` JOIN lie_a ON fk_co = co_id JOIN produit ON fk_pr = pr_reference WHERE co_statut = 'En attente';";
    $bdd = construct_();
...
foreach($result as $res){
    ...
    //Avoir le prix total de chaque article(s)
